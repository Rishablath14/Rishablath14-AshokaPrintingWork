...
export default function DataTableDemo() {
  ...
  const customerData = React.useMemo(() => customers, [customers]);
    ...
    <section className="surface-card p-5 md:p-6">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <h2 className="section-heading">All job records</h2>
            <p className="section-copy">Search by customer, phone number, or status and manage jobs inline.</p>
          </div>
          <div className="surface-card-muted inline-flex items-center gap-2 self-start px-4 py-2 text-sm text-slate-500 dark:text-slate-400">
            ...
            {table.getFilteredRowModel().rows.length} visible jobs
          </div>
        </div>
              ...
              {table.getRowModel().rows.length ? (
                ...
                <TableRow>
                  <TableCell colSpan={columns.length} className="h-28 text-center text-sm text-slate-500 dark:text-slate-400">
                    No customer jobs match the current filters.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
